...
export default function PanelSocialDashboardPage() {
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 flex items-center gap-4">
          ...
          <div>
            <span className="block text-2xl font-bold text-gray-900 dark:text-white">{myPosts.length}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {myPosts.map(post => (
          <div key={post.id} className="relative group">
            <PostCard post={post} basePath={BASE} />
