...
export default function PanelProfilePage(props: PageProps) {
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="border-b border-gray-200 dark:border-gray-800">
        <nav className="flex gap-8" aria-label="Tabs">
          <button className="border-b-2 border-green-500 py-4 px-1 text-sm font-medium text-green-600 dark:text-green-400" aria-current="page">پروژه‌ها</button>
          <button className="border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300">درباره من</button>
        </nav>
      </div>
