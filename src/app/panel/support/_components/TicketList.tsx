  ...
  return (
    <section className="space-y-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        <div className="scrollbar-hide -mx-1 flex min-w-0 flex-1 items-center gap-2 overflow-x-auto px-1 pb-0.5 lg:mx-0 lg:px-0">
          {tabs.map((tab) => (
            <button
              key={tab.id}
          ...
          <div className="space-y-2.5">
            {paginatedTickets.map((ticket) => (
              <Link
                ...
                className="block rounded-2xl border border-gray-200/70 bg-white p-4 transition-all hover:border-primary/25 dark:border-white/5 dark:bg-[#1c1e26]/80 dark:hover:bg-[#1c1e26] cursor-pointer lg:p-5"
              >
