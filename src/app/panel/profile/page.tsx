    ...
    <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-gray-500 dark:text-gray-400">
              <div className="flex items-center gap-1.5">
                ...
                <span>{settings.location || "تهران، ایران"}</span>
              </div>
              <div className="flex items-center gap-1.5">
            ...
            <div className="flex gap-6 pt-4 border-t border-gray-100 dark:border-white/[0.06]">
              <div className="flex items-center gap-1">
                <span className="font-bold text-gray-900 dark:text-white">{currentUser.followersCount}</span>
                <span className="text-gray-500 text-sm">دنبال‌کننده</span>
              </div>
              <div className="flex items-center gap-1">
                <span className="font-bold text-gray-900 dark:text-white">{currentUser.followingCount}</span>
      ...
      <div className="border-b border-gray-200 dark:border-white/[0.06]">
        <nav className="flex gap-8" aria-label="Tabs">
          <button className="border-b-2 border-green-500 py-4 px-1 text-sm font-medium text-green-600 dark:text-green-400 cursor-pointer" aria-current="page">
            پروژه‌ها
          </button>
          <button className="border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 cursor-pointer">
            درباره من
          </button>
        </nav>
      </div>
