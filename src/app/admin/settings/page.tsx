    ...
    <div className="mx-auto max-w-4xl space-y-8" dir="rtl">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          تنظیمات ظاهر، دستگاه‌های فعال و عملکرد پنل مدیریت را مدیریت کنید.
        </p>
      </div>

      <ThemeSettingsPanel
        description="حالت نمایش پنل ادمین را انتخاب کنید. تغییرات بلافاصله اعمال می‌شود."
        infoText="پوسته انتخابی شما به‌صورت خودکار ذخیره می‌شود و در تمام بخش‌های پنل مدیریت اعمال خواهد شد."
      />
