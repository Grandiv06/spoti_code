      ...
      <header className="relative pt-20 pb-40 px-6 min-h-[calc(100vh-80px)] flex flex-col justify-center items-center text-center overflow-hidden z-10">
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-10">
            <button className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-10 py-5 rounded-2xl font-bold text-xl shadow-lg shadow-emerald-200 dark:shadow-emerald-900/30 hover:shadow-emerald-300 dark:hover:shadow-emerald-900/50 hover:scale-105 transition-all flex items-center justify-center gap-3 cursor-pointer">
