...
export default function AuthHeader() {
  ...
  return (
    <header
      className={`fixed z-50 px-6 transition-all duration-300 ease-out bg-white/95 dark:bg-[#14161c]/95 backdrop-blur-xl border-gray-200 dark:border-slate-400/25 ${
        isScrolled
