...
import { confirmTotpSetup, SecurityError } from "@/server/services/user-security.service";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = await confirmTotpSetup(user, code);
    ...
    console.error("[POST /api/dashboard/security/totp/verify]", error);
