...
export const NotificationItem: React.FC<NotificationItemProps> = ({ notification }) => {
  ...
  const getText = () => {
    switch (notification.type) {
      case 'LIKE':
        return <span className="text-gray-600 dark:text-gray-300">پست شما را پسندید.</span>;
      case 'COMMENT':
        return <span className="text-gray-600 dark:text-gray-300">برای پست شما نظر گذاشت.</span>;
      case 'FOLLOW':
        return <span className="text-gray-600 dark:text-gray-300">شما را دنبال کرد.</span>;
      case 'MENTION':
        return <span className="text-gray-600 dark:text-gray-300">شما را در یک پست ذکر کرد.</span>;
       default:
        return null;
    }
  };
  ...
  return (
    ...
    >
        ...
        <div className="relative shrink-0">
            <Avatar src={notification.actor.avatarUrl} alt={notification.actor.displayName} size="md" />
